...
CREATE INDEX VISIT_ID_INDEX ON VISITS (ANIMAL_ID);
CREATE INDEX VET_INDEX_ID ON VISITS (VET_ID) INCLUDE (ANIMAL_ID,DATE_OF_VISIT);
CREATE INDEX EMAIL_INDEX_ID ON OWNERS (EMAIL);
